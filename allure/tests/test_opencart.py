import allure
from otus.allure.page_objects.CatalogPage import CatalogPage
from otus.allure.page_objects.MainPage import MainPage
from otus.allure.page_objects.RegisterPage import RegisterPage
