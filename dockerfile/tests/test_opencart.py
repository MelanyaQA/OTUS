...
from OTUS.dockerfile.page_objects.CatalogPage import CatalogPage
from OTUS.dockerfile.page_objects.MainPage import MainPage
from OTUS.dockerfile.page_objects.RegisterPage import RegisterPage
