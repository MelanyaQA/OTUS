from OTUS.page_object.page_objects.CatalogPage import CatalogPage
from OTUS.page_object.page_objects.MainPage import MainPage
from OTUS.page_object.page_objects.RegisterPage import RegisterPage
