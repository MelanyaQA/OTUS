from OTUS.page_object_hw.page_objects_1.CatalogPage_old import CatalogPage
from OTUS.page_object_hw.page_objects_1.MainPage_old import MainPage
from OTUS.page_object_hw.page_objects_1.RegisterPage_old import RegisterPage
